...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     *            '-----------------'        '-----------------'
     */
    [_OSRS] = LAYOUT_ferris_wrapper( _________________OSRS_L1_________________, _______, _______, _______, _______, _______,
                                    _________________OSRS_L2_________________, _______, _______, _______, _______, _______,
                                    _________________OSRS_L3_________________, _______, _______, _______, _______, _______,
                                    ____THUMB_L____, ____THUMB_R____)
